        ...
        <React.Fragment>
            <Dropdown isOpen={isCartDropdown} toggle={toggleCartDropdown} className="topbar-head-dropdown ms-1 header-item">
                <DropdownToggle type="button" tag="button" className="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle">
                    ...
                    <span
                        className="position-absolute topbar-badge translate-middle badge rounded-pill bg-info">{cartItem}<span
