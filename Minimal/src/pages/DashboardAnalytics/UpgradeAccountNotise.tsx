            ...
            <Col xs={12}>
                <Card>
                    <CardBody className="p-0">
                        <Alert className="alert border-0 rounded-0 m-0 d-flex align-items-center" role="alert" color="primary">
                            <FeatherIcon icon="alert-triangle" className="text-primary me-2 icon-sm" />
