                    ...
                    <CardBody>
                        ...
                        <div className="mt-3 pt-2">
                            <div className="progress progress-lg rounded-pill">
                                ...
                                <div className="progress-bar bg-secondary" role="progressbar" style={{ width: "18%" }}></div>
                        ...
                        <div className="mt-3 pt-2">
                            ...
                            <div className="d-flex mb-2">
                                <div className="flex-grow-1">
                                    <p className="text-truncate text-muted fs-14 mb-0"><i className="mdi mdi-circle align-middle text-secondary me-2"></i>www.youtube.com</p>
                                </div>
                                <div className="flex-shrink-0">
