                    ...
                    <Card>
                        <CardBody>
                            <div className="text-muted">
                                ...
                                <div>
                                    <button type="button" className="btn btn-link link-secondary p-0">Read more</button>
                                </div>
                                    ...
                                    <Row className="gy-3">
                                        ...
                                        <Col lg={3} sm={6}>
                                            <div>
                                                ...
                                                <div className="badge bg-success fs-12">High</div>
                                            </div>
                                        </Col>
                                        <Col lg={3} sm={6}>
                                            <div>
                                                <p className="mb-2 text-uppercase fw-medium">Status :</p>
                                                <div className="badge bg-primary fs-12">Inprogress</div>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                    ...
                    <Card>
                        ...
                        <CardBody>
                            ...
                            <form className="mt-4">
                                <Row className="g-3">
                                    <Col xs={12} >
                                        <label htmlFor="exampleFormControlTextarea1" className="form-label text-dark">Leave a Comments</label>
                                    ...
                                    <Col xs={12} className="text-end">
                                        <button type="button" className="btn btn-ghost-primary btn-icon waves-effect me-1"><i className="ri-attachment-line fs-16"></i></button>
                ...
                <Col xl={3} lg={4}>
                    ...
                    <Card>
                        <CardHeader className="align-items-center d-flex border-bottom-dashed">
                            ...
                            <div className="flex-shrink-0">
                                <button type="button" className="btn btn-soft-primary btn-sm" data-bs-toggle="modal" data-bs-target="#inviteMembersModal"><i className="ri-share-line me-1 align-bottom"></i> Invite Member</button>
                            </div>
                        </CardHeader>
