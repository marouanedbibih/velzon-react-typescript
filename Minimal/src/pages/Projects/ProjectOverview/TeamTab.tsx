        ...
        <React.Fragment>
            <Row className="g-4 mb-3">
                ...
                <div className="col-sm-auto">
                    <div>
                        <button type="button" className="btn btn-primary" onClick={openModal}><i className="ri-share-line me-1 align-bottom"></i> Invite Member</button>
                    </div>
                </div>
            </Row>
            ...
            <Modal isOpen={modal} toggle={openModal} centered className="border-0">
                ...
                <div className="modal-footer">
                    ...
                    <button type="button" className="btn btn-primary w-xs">Invite</button>
                </div>
