                        ...
                        <Col sm={6} xl={3}>
                            <Card>
                                ...
                                <div className="card-footer">
                                    ...
                                    <Link to="#" className="card-link">Bookmark <i className="ri-bookmark-line align-middle ms-1 lh-1"></i></Link>
                                </div>
                            </Card>
                        </Col>
                        <Col sm={6} xl={3}>
                            ...
                            <Row>
                                <Col lg={6} xxl={4}>
                                    <Card className="card-body">
                                        ...
                                        <Link to="#" className="btn btn-soft-primary">Apply Now</Link>
                                    </Card>
                                </Col>
                                <Col lg={6} xxl={4}>
                                    <div className="card card-body text-center">
                                        ...
                                        <p className="card-text text-muted">Send a link to apply on mobile device. Appropriately communicate one-to-one technology.</p>
                                        <Link to="#" className="btn btn-soft-primary">Add New</Link>
                                    </div>
                                </Col>
                                <Col lg={6} xxl={4}>
                            ...
                            <Row>
                                <Col lg={6} xxl={4}>
                                    <Card>
                                        ...
                                        <div className="card-footer">
                                            <Link to="#" className="link-primary float-end">Read More <i className="ri-arrow-right-s-line align-middle ms-1 lh-1"></i></Link>
                                ...
                                <Col lg={6} xxl={4}>
                                    <Card>
                                        ...
                                        <div className="card-footer">
                                            <Link to="#" className="link-primary float-end">Payment Now <i className="ri-arrow-right-s-line align-middle ms-1 lh-1"></i></Link>
                            ...
                            <Card>
                                ...
                                <div className="card-footer">
                                    <div className="hstack gap-2 justify-content-end">
                                        <Link to="#" className="btn btn-link btn-sm"><i className="ri-close-line align-middle lh-1"></i> Close</Link>
                                    ...
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-shrink-0">
                                            <ul className="list-inline card-toolbar-menu d-flex align-items-center mb-0">
                                                <li className="list-inline-item">
                                                    <Link to="#" className="align-middle" data-toggle="reload" >
                                ...
                                <CardHeader>
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-shrink-0">
                                            <ul className="list-inline card-toolbar-menu d-flex align-items-center mb-0">
                                                <li className="list-inline-item">
                                                    <Link to="#" className="align-middle" data-toggle="growing-reload">
                                                        <i className="mdi mdi-refresh align-middle"></i>
                                                    </Link>
                                                </li>
                                                <li className="list-inline-item">
                                ...
                                <CardHeader>
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-shrink-0">
                                            <ul className="list-inline card-toolbar-menu d-flex align-items-center mb-0">
                                                <li className="list-inline-item">
                                                    <Link to="#" className="align-middle" data-toggle="customer-loader">
                                                        <i className="mdi mdi-refresh align-middle"></i>
                                                    </Link>
                                                </li>
                                                <li className="list-inline-item">
                    ...
                    <Row>
                        ...
                        <Col xxl={4}>
                            <Card className="card-light">
                                ...
                                <div className="card-footer">
                                    <div className="text-center">
                                        <Link to="#" className="text-dark">Connect Now <i className="ri-arrow-right-s-line align-middle lh-1"></i></Link>
                                    </div>
                                </div>
                            </Card>
                        </Col>
                        ...
                        <Col xxl={4}>
                            <Card className="border card-border-dark">
                                ...
                                <CardBody>
                                    <p className="card-text">They all have something to say beyond the words on the page. They can come across as casual or neutral, exotic or graphic. Cosby sweater eu banh mi, qui irure terry richardson ex squid.</p>
                                    <div className="text-end">
                                        <Link to="#" className="text-dark fw-medium">Read More <i className="ri-arrow-right-line align-middle"></i></Link>
                                    </div>
                                </CardBody>
                            </Card>
                        </Col>
                            ...
                            <Row>
                                ...
                                >
                                    ...
                                    <Card>
                                        ...
                                        <div className="card-footer">
                                            <Link to="#" className="float-end">Read More <i className="ri-arrow-right-s-line align-middle ms-1 lh-1"></i></Link>
                                            <p className="text-muted mb-0">1 days Ago</p>
                                        </div>
                                    </Card>
