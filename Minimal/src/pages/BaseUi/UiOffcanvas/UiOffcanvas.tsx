                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-2">
                                            ...
                                            <Button color="info" onClick={toggleLeftCanvas}>Toggle Left Offcanvas</Button>
                                        </div>
                                    </div>
                                    <div className="d-none code-view">
                                        <pre className="language-markup" style={{ height: "275px" }}>
            ...
            <Offcanvas isOpen={open} toggle={toggleDefultCanvas} id="offcanvasExample">
                ...
                <OffcanvasBody className="p-0 overflow-hidden">
                    <SimpleBar style={{ height: "100vh" }}>
                        <div className="Activity-timeline p-4">
                            ...
                            <div className="Activity-item py-3 d-flex">
                                ...
                                <div className="flex-grow-1 ms-3">
                                    ...
                                    <p className="text-muted mb-2"><i className="ri-file-text-line align-middle ms-2"></i> Create new project Buildingproduct</p>
                            ...
                            <div className="Activity-item py-3 d-flex">
                                <div className="flex-shrink-0">
                                    <img src={avatar7} alt="" className="avatar-xs rounded-circle Activity-avatar" />
                                </div>
                                <div className="flex-grow-1 ms-3">
                            ...
                            <div className="Activity-item d-flex">
                                <div className="flex-shrink-0">
                                    <img src={avatar8} alt="" className="avatar-xs rounded-circle Activity-avatar" />
                                </div>
                                <div className="flex-grow-1 ms-3">
                    ...
                    <Row className="gallery-light">
                            ...
                            <Card className="gallery-box light mb-0">
                                ...
                                <div className="box-content">
                                    <div className="d-flex align-items-center mt-1">
                                        <div className="flex-grow-1 text-muted">by <Link to="#" className="text-dark text-truncate">Erica Kernan</Link></div>
                                        <div className="flex-shrink-0">
                        ...
                        <Col xl={3} lg={4} sm={6}>
                            <Card className="gallery-box light mb-0">
                                ...
                                <div className="box-content">
                                    <div className="d-flex align-items-center mt-1">
                                        <div className="flex-grow-1 text-muted">by <Link to="#" className="text-dark text-truncate">Ron Mackie</Link></div>
                                        <div className="flex-shrink-0">
                                            <div className="d-flex gap-3">
                                                <button type="button" className="btn btn-sm fs-12 btn-link text-dark text-decoration-none px-0">
                        ...
                        <Col xl={3} lg={4} sm={6}>
                            <Card className="gallery-box mb-0">
                                ...
                                <div className="box-content">
                                    <div className="d-flex align-items-center mt-1">
                                        <div className="flex-grow-1 text-muted">by <Link to="#" className="text-dark text-truncate">Nancy Martino</Link></div>
                                        <div className="flex-shrink-0">
                                            <div className="d-flex gap-3">
                                                <button type="button" className="btn btn-sm fs-12 btn-link text-dark text-decoration-none px-0">
                        ...
                        <Col xl={3} lg={4} sm={6} className="d-md-none d-xl-block">
                            <Card className="gallery-box mb-0">
                                ...
                                <div className="box-content">
                                    <div className="d-flex align-items-center mt-1">
                                        <div className="flex-grow-1 text-muted">by <Link to="#" className="text-dark text-truncate">Henry Baird</Link></div>
                                        <div className="flex-shrink-0">
                                            <div className="d-flex gap-3">
                                                <button type="button" className="btn btn-sm fs-12 btn-link text-dark text-decoration-none px-0">
