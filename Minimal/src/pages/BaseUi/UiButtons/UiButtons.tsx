...
import { Button, Card, CardBody, Col, Container, DropdownItem, DropdownMenu, DropdownToggle, Row, UncontrolledButtonDropdown, ButtonGroup, ButtonToolbar, Input } from 'reactstrap';
...
import {
    DefaultButtonsExample, OutlineButtonsExample, RoundedButtonsExample, SoftButtonsExample,
    GradientButtonsExample, AnimationButtonsExample, LabelButtonsExample, SizeButtonsExample,
    WidthButtonsExample, TagButtonsExample, GridButtonsExample, CheckButtonsExample,
    GroupButtonsExample, IconButtonsExample, ToolbarButtonsExample, GroupsizingButtonsExample,
    VerticalButtonsExample, GhostButtonsExample, LoadMoreButtonsExample, BorderButtonsExample, CustomToggleButtonsExample,
    BaseClassExample, CustomExample, FocusRingExample, FocusRingUtilitiesExample
} from './UiButtonCode';
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>btn-soft-</code>  class with the below-mentioned variation to create a button with the soft background.</p>                                        <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-2">
                                            <Button color='soft-primary' className="waves-effect waves-light"> Primary </Button>
                                            <Button color='soft-secondary' className="waves-effect waves-light"> Secondary </Button>
                                            <Button color='soft-success' className="waves-effect waves-light"> Success </Button>
                                            <Button color='soft-info' className="waves-effect waves-light"> Info </Button>
                                            <Button color='soft-warning' className="waves-effect waves-light"> Warning </Button>
                                            <Button color='soft-danger' className="waves-effect waves-light"> Danger </Button>
                                            <Button color='soft-dark' className="waves-effect waves-light"> Dark </Button>
                                        </div>
                                    </div>
                                    <div className="d-none code-view">
                                        <pre className="language-markup" style={{ height: "275px" }}>
                                        ...
                                        <Row>
                                            ...
                                            <Col lg={6}>
                                                <div className="d-flex flex-wrap align-items-center gap-2">
                                                    ...
                                                    <Button color="soft-warning" className="custom-toggle active" onClick={(e) => favouriteBtn(e.target)}>
                                                        <span className="icon-on">Follow</span>
                                                        <span className="icon-off">Unfollow</span>
                                                    </Button>
                                                    <Button color="soft-danger" className="custom-toggle" onClick={(e) => favouriteBtn(e.target)}>
                                                        <span className="icon-on">On</span>
                                                        <span className="icon-off">Off</span>
                                                    </Button>
                            ...
                            <Col lg={6}>
                                <Card>
                                    ...
                                    <CardBody>
                                        ...
                                        <div className="live-preview">
                                            <div className="d-flex flex-wrap gap-2">
                                            <button className='btn' type="button" >Base class</button>
                                            </div>
                                        </div>
                                        <div className="d-none code-view">
                                            <pre className="language-markup">
