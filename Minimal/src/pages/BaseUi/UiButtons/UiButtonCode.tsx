...
<div className="d-flex gap-3">
    ...
    <Link to="#!" className="d-inline-flex focus-ring py-1 px-2 text-decoration-none border rounded-2" style="--vz-focus-ring-color: rgba(118, 93, 255, .25)">
        Custom focus ring
    </Link>

    <Link to="#!" className="d-inline-flex focus-ring py-1 px-2 text-decoration-none border rounded-2" style="--vz-focus-ring-x: 10px; --vz-focus-ring-y: 10px; --vz-focus-ring-blur: 4px">
...
const FocusRingUtilitiesExample = () => (
    <PrismCode
        code={focusRingUtilitiesCode}
        language={("js")}
        plugins={["line-numbers"]}
    />
);
