...
<div className="hstack flex-wrap gap-2">
    ...
    <Button className="btn btn-info" id="borderedTost3Btn" onClick={() => setToast9(!toast9)} >Warning Toast</Button>
...
<div style={{ zIndex: "11" }}>
    <Toast isOpen={toast9} id="borderedToast3" className="toast-border-info overflow-hidden mt-3">
        <ToastBody>
            <div className="d-flex align-items-center">
                <div className="flex-shrink-0 me-2">
