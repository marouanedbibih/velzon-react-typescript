...
import { Alert, Button, Card, CardBody, Col, Container, Input, Modal, ModalHeader, ModalBody, PopoverBody, PopoverHeader, Row, UncontrolledPopover, UncontrolledTooltip } from 'reactstrap';
...
const UiModals = () => {
    ...
    return (
        <React.Fragment>
            ...
            >
                ...
                <div className="modal-body text-center p-5">
                    ...
                    <div className="mt-4">
                        ...
                        <p className="text-muted mb-4"> The transfer was not successfully received by us. the email of the recipient wasn't correct.</p>
                        <div className="hstack gap-2 justify-content-center">
                            <Link to="#" className="btn btn-link link-primary fw-medium" onClick={() => setmodal_backdrop(false)}><i className="ri-close-line me-1 align-middle"></i> Close</Link>
                            <Link to="#" className="btn btn-primary" onClick={() => setmodal_backdrop(false)}>Completed</Link>
                        </div>
                    </div>
                </div>
            </Modal>
            ...
            >
                <ModalHeader className="modal-title" id="exampleModalFullscreenLabel" toggle={() => { tog_fullscreen(); }}>
            ...
            >
                <ModalHeader className="modal-title" id="myExtraLargeModalLabel" toggle={() => { tog_xlarge(); }} >
                    Extra large modal
                </ModalHeader>
                <div className="modal-body">
                    <h6 className="fs-15">Give your text a good structure</h6>
            ...
            >
                <ModalHeader className="modal-title" id="myLargeModalLabel" toggle={() => { tog_large(); }}>
                    Large Modal
                </ModalHeader>
                <div className="modal-body">
                    <h6 className="fs-15">Give your text a good structure</h6>
            ...
            >
                <ModalHeader className="modal-title" id="mySmallModalLabel" toggle={() => { tog_small(); }}>
                    Small Modal
                </ModalHeader>
                <div className="modal-body">
                    <h6 className="fs-15">Give your text a good structure</h6>
            ...
            >
                <ModalHeader className="modal-title" id="fullscreeexampleModalLabel" toggle={() => { tog_fullscreen1(); }}>
                    Full screen modal
                </ModalHeader>
                <div className="modal-body">
                    <h6 className="fs-15">Give your text a good structure</h6>
            ...
            <Modal id="exampleModalFullscreenSm" isOpen={modal_fullscreen_sm} toggle={() => { tog_fullscreen_sm(); }} >
                <ModalHeader toggle={() => { tog_fullscreen_sm(); }}>
            ...
            <Modal id="exampleModalFullscreenMd" isOpen={modal_fullscreen_md} toggle={() => { tog_fullscreen_md(); }} >
                <ModalHeader toggle={() => { tog_fullscreen_md(); }}>
            ...
            <Modal id="exampleModalFullscreenLg" isOpen={modal_fullscreen_lg} toggle={() => { tog_fullscreen_lg(); }} >
                <ModalHeader toggle={() => { tog_fullscreen_lg(); }}>
            ...
            <Modal id="exampleModalFullscreenXl" isOpen={modal_fullscreen_xl} toggle={() => { tog_fullscreen_xl(); }} >
                <ModalHeader toggle={() => { tog_fullscreen_xl(); }}>
            ...
            <Modal id="exampleModalFullscreenXxl" isOpen={modal_fullscreen_xxl} toggle={() => { tog_fullscreen_xxl(); }} >
                <ModalHeader toggle={() => { tog_fullscreen_xxl(); }}>
                    Modal Heading
                </ModalHeader>
                <div className="modal-body">
                    <h6 className="fs-15">Give your text a good structure</h6>
            ...
            <Modal id="fadeInRightModal" isOpen={modal_animationRight} toggle={() => { tog_animationRight(); }} modalClassName="fadeInRight" centered >
                <ModalHeader toggle={() => { tog_animationRight(); }}>
                    Modal Heading
                </ModalHeader>
                <div className="modal-body">
                    <h5 className="fs-16">
            ...
            <Modal id="fadeInleftModal" isOpen={modal_animationLeft} toggle={() => { tog_animationLeft(); }} modalClassName="fadeInLeft" centered >
                <ModalHeader toggle={() => { tog_animationLeft(); }}>
                    Modal Heading
                </ModalHeader>
                <div className="modal-body">
                    <h5 className="fs-16">
            ...
            <Modal id="fadeInUpModal" isOpen={modal_animationUp} toggle={() => { tog_animationUp(); }} modalClassName="fadeInUp" centered >
                <ModalHeader toggle={() => { tog_animationUp(); }}>
                    Modal Heading
                </ModalHeader>
                <div className="modal-body">
                    <h5 className="fs-16">
            ...
            <Modal id="flipModal" isOpen={modal_animationFlip} toggle={() => { tog_animationFlip(); }} modalClassName="flip" centered >
                <ModalHeader toggle={() => { tog_animationFlip(); }}>
                    Modal Heading
                </ModalHeader>
                <div className="modal-body">
                    <h5 className="fs-16">
            ...
            <Modal id="flipModal" isOpen={modal_animationZoom} toggle={() => { tog_animationZoom(); }} modalClassName="zoomIn" centered >
                <ModalHeader toggle={() => { tog_animationZoom(); }}>
                    Modal Heading
                </ModalHeader>
                <div className="modal-body">
                    <h5 className="fs-16">
            ...
            <Modal id="topmodal" isOpen={modal_positionTop} toggle={() => { tog_positionTop(); }} >
                <ModalHeader toggle={() => { tog_positionTop(); }}>
                    Modal Heading
                </ModalHeader>
                <div className="modal-body text-center p-5">
                    ...
                    <div className="mt-4">
                        ...
                        <p className="text-muted mb-4"> The transfer was not successfully received by us. the email of the recipient wasn't correct.</p>
                        <div className="hstack gap-2 justify-content-center">
                            <Link to="#" className="btn btn-link link-primary fw-medium" onClick={() => { tog_positionTop(); }}><i className="ri-close-line me-1 align-middle"></i> Close</Link>
                            <Link to="#" className="btn btn-primary">Completed</Link>
                        </div>
                    </div>
                </div>
            </Modal>
            ...
            <Modal id="top-rightmodal" isOpen={modal_positionTopRight} toggle={() => { tog_positionTopRight(); }} className="modal-dialog-right" >
                <ModalHeader toggle={() => { tog_positionTopRight(); }}>
                    Modal Heading
                </ModalHeader>
                <div className="modal-body text-center p-5">
                    <i className="ri-emotion-happy-line display-2 text-success"></i>
                    <div className="mt-4">
                        ...
                        <p className="text-muted mb-4"> The transfer was not successfully received by us. the email of the recipient wasn't correct.</p>
                        <div className="hstack gap-2 justify-content-center">
                            <Link to="#" className="btn btn-link link-primary fw-medium" onClick={() => { tog_positionTopRight(); }}><i className="ri-close-line me-1 align-middle"></i> Close</Link>
                            <Link to="#" className="btn btn-primary">Completed</Link>
                        </div>
                    </div>
                </div>
            ...
            <Modal id="bottomModal" isOpen={modal_positionBottom} toggle={() => { tog_positionBottom(); }} className="modal-dialog-bottom" >
                <ModalHeader toggle={() => { tog_positionBottom(); }}>
                    Modal Heading
                </ModalHeader>
                <div className="modal-body text-center p-5">
                    <i className="ri-emotion-happy-line display-2 text-success"></i>
                    <div className="mt-4">
                        ...
                        <p className="text-muted mb-4">The transfer was not successfully received by us. the email of the recipient wasn't correct.</p>
                        <div className="hstack gap-2 justify-content-center">
                            <Link to="#" className="btn btn-link link-primary fw-medium" onClick={() => setmodal_positionBottom(false)}><i className="ri-close-line me-1 align-middle"></i> Close</Link>
                            <Link to="#" className="btn btn-primary">Completed</Link>
                        </div>
                    </div>
                </div>
            ...
            <Modal id="bottom-rightModal" isOpen={modal_positionBottomRight} toggle={() => { tog_positionBottomRight(); }} className="modal-dialog-bottom-right" >
                <ModalHeader toggle={() => { tog_positionBottomRight(); }}>
                    Modal Heading
                </ModalHeader>
                <div className="modal-body text-center p-5">
                    <i className="ri-emotion-happy-line display-2 text-success"></i>
                    <div className="mt-4">
                        ...
                        <p className="text-muted mb-4"> The transfer was not successfully received by us. the email of the recipient wasn't correct.</p>
                        <div className="hstack gap-2 justify-content-center">
                            <Link to="#" className="btn btn-link link-primary fw-medium" onClick={() => setmodal_positionBottomRight(false)}><i className="ri-close-line me-1 align-middle"></i> Close</Link>
                            <Link to="#" className="btn btn-primary">Completed</Link>
                        </div>
                    </div>
                </div>
