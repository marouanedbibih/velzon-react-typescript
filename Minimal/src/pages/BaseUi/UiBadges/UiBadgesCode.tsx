...
<span className="badge rounded-pill bg-light-subtle text-light">Light</span>
`;
...
<span className="badge bg-light-subtle text-darkbadge-border">Light</span>
`;
...
<span className="badge rounded-pill border border-light text-dark">Light</span>
`;
