...
const Widgets = () => {
    return (
        <React.Fragment>
            {(cyptoWidgets || []).map((item: any, key: number) => (
                        ...
                        <CardBody>
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-shrink-0 align-self-end">
                                    <span className={"badge bg-" + item.badgeColor + "-subtle text-" + item.badgeColor}>
                                        <i className={"align-middle me-1 " + item.badge}></i>{item.percentage} %
                                    </span>
                                </div>
                            </div>
                        </CardBody>
