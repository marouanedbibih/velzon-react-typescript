                ...
                <div className="card card-height-100">
                    ...
                    <div className="card-body">
                        <div id="portfolio_donut_charts"  className="apex-charts" dir="ltr">
                            <PortfolioCharts series={chartData} dataColors='["--vz-primary", "--vz-primary-rgb, 0.85", "--vz-primary-rgb, 0.65", "--vz-primary-rgb, 0.50"]' />
                        </div>
                            ...
                            <li className="list-group-item px-0">
                                <div className="d-flex">
                                    ...
                                    <div className="flex-grow-1 ms-2">
                                        ...
                                        <p className="fs-12 mb-0 text-muted"><i className="mdi mdi-circle fs-10 align-middle text-secondary  me-1"></i>ETH</p>
                                    </div>
                                    <div className="flex-shrink-0 text-end">
