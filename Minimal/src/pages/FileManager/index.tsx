...
const FileManager = () => {
    ...
    const fileSidebar = () => {
        const folderOverview: any = document.getElementById("folder-overview");
        const fileOverview: any = document.getElementById("file-overview");
                                    ...
                                    <Row className="justify-content-beetwen g-2 mb-4">
                                        ...
                                        <Col className="col-auto">
                                            <div className="d-flex gap-2 align-items-start">
                                                ...
                                                <button className="btn btn-primary text-nowrap create-folder-modal" onClick={() => handleFolderClicks()}><i className="ri-add-line align-bottom me-1"></i> Create Folders</button>
                                            </div>
                                        </Col>
                                    </Row>
                            ...
                            <SimpleBar className="mx-n3 pt-3 px-3 file-detail-content-scroll">
                                <div id="folder-overview">
                                    <div className="d-flex align-items-center pb-3 border-bottom border-bottom-dashed">
                                        ...
                                        <div>
                                            <button type="button" className="btn btn-soft-danger btn-icon btn-sm fs-16 close-btn-overview" onClick={() => setShowDetail(!showDetail)}>
                                                <i className="ri-close-fill align-bottom"></i>
                                            </button>
                                        </div>
                                    </div>
                                    <SimpleDonutCharts dataColors='["--vz-info", "--vz-warning", "--vz-primary", "--vz-success"]' dir="ltr" />
                                    <div className="mt-4">
                                    ...
                                    <div className="pb-3 mt-auto">
                                        <div className="alert alert-success d-flex align-items-center mb-0">
                                            <div className="flex-shrink-0">
                                                <i className="ri-cloud-line text-success align-bottom display-5"></i>
                                            </div>
                                            <div className="flex-grow-1 ms-3">
                                                <h5 className="text-success fs-14">Upgrade to Pro</h5>
                                                <p className="text-muted mb-2">Get more space for your...</p>
                                                <button className="btn btn-sm btn-success"><i className="ri-upload-cloud-line align-bottom"></i> Upgrade Now</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
