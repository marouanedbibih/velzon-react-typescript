                    ...
                    <Row>
                        ...
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <ZoomableTimeseries dataColors='["--vz-primary"]' />
                                </CardBody>
                            </Card>
                        </Col>
                    </Row>
                    ...
                    <Row>
                        ...
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <DashedLine dataColors='["--vz-primary", "--vz-info", "--vz-success"]' />
                                </CardBody>
                            </Card>
                        </Col>
                    </Row>
                    ...
                    <Row>
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <SteplineChart dataColors='["--vz-primary"]' />
                                </CardBody>
                            </Card>
                        </Col>
                    ...
                    <Row>
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <MissingData dataColors='["--vz-primary", "--vz-info", "--vz-success"]' />
                                </CardBody>
                            </Card>
                        </Col>
                        <Col lg={6}>
