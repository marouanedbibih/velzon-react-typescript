...
const PieCharts = () => {
    document.title = "Apex Pie Charts | Velzon - React Admin & Dashboard Template";
    return (
                ...
                <Row>
                    <Col xl={6}>
                        <Card>
                            ...
                            <CardBody>
                                <SimplePie dataColors='["--vz-primary", "--vz-primary-rgb, 0.85", "--vz-primary-rgb, 0.70", "--vz-primary-rgb, 0.55", "--vz-primary-rgb, 0.40"]' />
                            </CardBody>
                        </Card>
                    </Col>
                    ...
                    <Col xl={6}>
                        <Card>
                            ...
                            <CardBody>
                                <SimpleDonut dataColors='["--vz-primary", "--vz-primary-rgb, 0.85", "--vz-primary-rgb, 0.70", "--vz-primary-rgb, 0.55", "--vz-primary-rgb, 0.40"]' />
                            </CardBody>
                        </Card>
                    </Col>
                ...
                <Row className="row">
                    <Col xl={6}>
                        <Card>
                            ...
                            <CardBody>
                                <div>
                                    <UpdateDonut dataColors='["--vz-primary", "--vz-primary-rgb, 0.85", "--vz-primary-rgb, 0.65", "--vz-primary-rgb, 0.50"]' />
                ...
                <Row>
                    <Col xl={6}>
                        <Card>
                            ...
                            <CardBody>
                                <GradientDonut dataColors='["--vz-primary", "--vz-success", "--vz-warning", "--vz-secondary", "--vz-info"]' />
                            </CardBody>
                        </Card>
                    </Col>
                    ...
                    <Col xl={6}>
                        <Card>
                            ...
                            <CardBody>
                                <PatternedDonut dataColors='["--vz-primary", "--vz-success", "--vz-warning", "--vz-secondary", "--vz-info"]' />
                            </CardBody>
                        </Card>
                    </Col>
                </Row>
