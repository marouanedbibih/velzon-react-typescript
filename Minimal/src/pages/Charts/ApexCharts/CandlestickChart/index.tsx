                    ...
                    <Row>
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <Basic dataColors='["--vz-success", "--vz-primary"]'/>
                                </CardBody>
                            </Card>
                        </Col>
                                ...
                                <CardBody>
                                    <div>
                                        <div id="combo_candlestick">
                                            <ComboCandlestick dataColors='["--vz-info", "--vz-primary"]'/>
                                        </div>
                                        <div id="combo_candlestick_chart">
                                            <ComboCandlestick1 dataColors='["--vz-success", "--vz-primary"]'/>
                                        </div>
                                    </div>
                                </CardBody>
                            </Card>
                    ...
                    <Row>
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <Category dataColors='["--vz-success-rgb, 0.65", "--vz-danger-rgb, 0.65"]'/>
                                </CardBody>
                            </Card>
                        </Col>
                        <Col xl={6}>
