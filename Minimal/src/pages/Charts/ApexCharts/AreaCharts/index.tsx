...
const AreaCharts = () => {
    document.title="Apex Area Charts | Velzon - React Admin & Dashboard Template";
    return (
        <React.Fragment>
                    ...
                    <Row>
                        ...
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <NegativeAreaChart dataColors='["--vz-info", "--vz-primary"]' />
                                </CardBody>
                            </Card>
                        </Col>
                    </Row>
                    ...
                    <Row>
                                ...
                                <CardBody>
                                    <div>
                                        <div className="bg-light">
                                            <GithubStyleCharts dataColors='["--vz-success"]'/>
                                        </div>
                        ...
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <StackedAreaChart dataColors='["--vz-primary", "--vz-info", "--vz-light"]'/>
                                </CardBody>
                            </Card>
                        </Col>
                    </Row>
                    ...
                    <Row>
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <IrregularAreaCharts dataColors='["--vz-primary", "--vz-info", "--vz-success"]'/>
                                </CardBody>
                            </Card>
                        </Col>
