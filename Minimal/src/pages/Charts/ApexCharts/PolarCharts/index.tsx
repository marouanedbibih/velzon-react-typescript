...
const Polarcharts = () => {
    document.title="Apex Polar Charts | Velzon - React Admin & Dashboard Template";
    return (
                ...
                <Row>
                    <Col xl={6}>
                        <Card>
                            ...
                            <CardBody>
                                <BasicPolar dataColors='["--vz-primary", "--vz-success", "--vz-warning","--vz-light", "--vz-info", "--vz-primary", "--vz-danger", "--vz-dark", "--vz-secondary"]'/>
                            </CardBody>
                        </Card>
                    </Col>
