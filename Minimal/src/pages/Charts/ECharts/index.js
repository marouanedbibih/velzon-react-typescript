                ...
                <Row>
                    <Col xl={6}>
                        <Card>
                            ...
                            <CardBody>
                                <LineChart dataColors='["--vz-primary"]'/>
                            </CardBody>
                        </Card>
                    </Col>
                    <Col xl={6}>
                        <Card>
                            ...
                            <div className="card-body">
                                <StackedLineChart dataColors='["--vz-primary", "--vz-success", "--vz-warning", "--vz-secondary", "--vz-info"]'/>
                            </div>
                        </Card>
                    </Col>
                </Row>
                <Row>
                    ...
                    <Col xl={6}>
                        <Card>
                            ...
                            <div className="card-body">
                                <StackedAreaChart dataColors='["--vz-primary", "--vz-success", "--vz-warning", "--vz-light", "--vz-info"]'/>
                            </div>
                        </Card>
                    </Col>
                </Row>
                ...
                <Row>
                    <Col xl={6}>
                        <Card>
                            ...
                            <div className="card-body">
                                <StepLineChart dataColors='["--vz-primary", "--vz-light", "--vz-info"]'/>
                            </div>
                        </Card>
                    </Col>
                ...
                <Row>
                    <Col xl={6}>
                        <Card>
                            ...
                            <div className="card-body">
                                <BasicBarChart dataColors='["--vz-primary"]'/>
                            </div>
                        </Card>
                    </Col>
                    ...
                    <Col xl={6}>
                        <Card>
                            ...
                            <div className="card-body">
                                <BarLabelChart dataColors='["--vz-primary", "--vz-info", "--vz-success", "--vz-light"]'/>
                            </div>
                        </Card>
                    </Col>
                </Row>
                ...
                <Row>
                    ...
                    <Col xl={6}>
                        <Card>
                            ...
                            <div className="card-body">
                                <StackedHorizontalBarChart dataColors='["--vz-primary", "--vz-success", "--vz-warning", "--vz-light", "--vz-info"]'/>
                            </div>
                        </Card>
                    </Col>
                </Row>
                ...
                <Row>
                    <Col xl={6}>
                        <Card>
                            ...
                            <div className="card-body">
                                <PieChart dataColors='["--vz-primary", "--vz-success", "--vz-warning", "--vz-light", "--vz-info"]'/>
                            </div>
                        </Card>
                    </Col>
                    ...
                    <Col xl={6}>
                        <Card>
                            ...
                            <div className="card-body">
                                <DoughnutChart dataColors='["--vz-primary", "--vz-primary-rgb, 0.80", "--vz-primary-rgb, 0.70", "--vz-primary-rgb, 0.60", "--vz-primary-rgb, 0.45"]'/>
                            </div>
                        </Card>
                    </Col>
                </Row>
                ...
                <Row>
                    ...
                    <Col xl={6}>
                        <Card>
                            ...
                            <div className="card-body">
                                <CandleStickChart dataColors='["--vz-primary", "--vz-info"]'/>
                            </div>
                        </Card>
                    </Col>
                </Row>
                ...
                <Row>
                    <Col xl={6}>
                        <Card>
                            ...
                            <div className="card-body">
                                <SunburstChart dataColors='["--vz-info", "--vz-primary"]'/>
                            </div>
                        </Card>
                    </Col>
                    ...
                    <Col xl={6}>
                        <Card>
                            ...
                            <div className="card-body">
                                <ParallelChart dataColors='["--vz-primary"]'/>
                            </div>
                        </Card>
                    </Col>
                </Row>
                ...
                <Row>
                    ...
                    <Col xl={6}>
                        <Card>
                            ...
                            <div className="card-body">
                                <HeatmapChart dataColors='["--vz-primary", "--vz-info"]'/>
                            </div>
                        </Card>
                    </Col>
                </Row>
