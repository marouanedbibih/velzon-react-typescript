                    ...
                    <Row className="g-3">
                        ...
                        <Col xxl={2} lg={6}>
                            <select className="form-control" data-choices data-choices-search-false name="choices-single-default"
                                ...
                                onChange={(e: any) => rating(e.target.value)}>
                                    ...
                                    <Card className="mb-2" key={key}>
                                        <CardBody>
                                            <div className="d-flex mb-3">
                                                ...
                                                <div>
                                                    <Link to="#" className="badge bg-secondary-subtle text-secondary">Visit Website <i className="ri-arrow-right-up-line align-bottom"></i></Link>
                                                </div>
                                            </div>
                                        ...
                                        <Col xxl={3} md={6}>
                                            ...
                                            {(item.subItem || []).map((subItem:any, key:number) => (
                                                <Card className="mb-2 ribbon-box ribbon-fill right" key={key}>
                                                    <div className="ribbon ribbon-primary shadow-none"><i className="ri-flashlight-fill me-1"></i>{subItem.ribbonNumber}</div>
                                                    <CardBody>
                                                        <div className="d-flex mb-3">
                                                            <div className="flex-shrink-0 avatar-sm">
                                                                <div className="avatar-title bg-light rounded">
