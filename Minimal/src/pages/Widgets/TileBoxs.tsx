...
const TileBoxs = () => {
    return (
        <React.Fragment>
            ...
            <Row>
                {(tileBoxs1 || []).map((item:any, key:number) => (
                    ...
                    <Card className="crm-widget">
                        <CardBody className="p-0">
                            <Row className="row-cols-md-3 row-cols-1">
                                ...
                                {(tileBoxs2 || []).map((item:any, key:number) => (
            ...
            <Row>
                {(tileBoxs3 || []).map((item:any, key:number) => (<Col xl={3} md={6} key={key}>
                    <Card className={"card-animate " + item.bgColor}>
                        <CardBody>
            ...
            <Row>
                {(tileBoxes4 || []).map((item:any, key:number) => (<Col xl={3} md={6} key={key}>
            ...
            <Row>
                {(tileBoxes5 || []).map((item:any, key:number) => (
