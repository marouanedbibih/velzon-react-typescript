                            ...
                            <Card className="card-height-100">
                                ...
                                <CardBody className="p-0">
                                    ...
                                    <div className="align-items-center p-3 justify-content-between d-flex">
                                        ...
                                        <Button color="primary" size="sm" ><i className="ri-add-line align-middle me-1"></i> Add Task</Button>
                                    </div>
                                    ...
                                    <SimpleBar style={{ maxHeight: "364px" }} className="p-3">
                                        <div className="Activity-timeline Activity-main">
                                            ...
                                            <div className="Activity-item py-3 d-flex">
                                                ...
                                                <div className="flex-grow-1 ms-3">
                                                    <h6 className="mb-1">Favorite Product</h6>
                                            ...
                                            <div className="Activity-item d-flex">
                                                <div className="flex-shrink-0">
                                                    <img src={avatar3} alt="" className="avatar-xs rounded-circle Activity-avatar" />
                                                </div>
                                                <div className="flex-grow-1 ms-3">
