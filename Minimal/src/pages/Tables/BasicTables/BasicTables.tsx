                                                ...
                                                <Table className="table-striped table-nowrap align-middle mb-0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Nov 21, 2021</td>
                                                            <td>$1,450</td>
                                                            <td><span className="badge bg-warning-subtle text-warning">Waiting</span></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Nov 25, 2021</td>
                                                            <td>$6,875</td>
                                                            <td><span className="badge bg-danger-subtle text-danger">Cancelled</span></td>
                                                        </tr>
                                                    </tbody>
                                                </Table>
                                            </div>
                                            ...
                                            <Row>
                                                ...
                                                <Col xl={6}>
                                                    <div className="table-responsive mt-4 mt-xl-0">
                                                        <Table className="table-primary table-striped table-nowrap align-middle mb-0">
                                                            <thead>
                                                                <tr>
                                                                    <th scope="col">ID</th>
                                                                    <th scope="col">Invoice</th>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div className="hstack gap-3 flex-wrap">
                                                                            <Link to="#" className="fs-15"><i className="ri-edit-2-line"></i></Link>
                                                                            <Link to="#" className="link-success fs-15"><i className="ri-delete-bin-line"></i></Link>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                ...
                                                <Table className="align-middle table-nowrap mb-0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>06 Oct, 2021</td>
                                                            <td>$21.25</td>
                                                            <td><span className="badge bg-danger-subtle text-danger">Refund</span></td>
                                                            <td>
                                                                <button type="button" className="btn btn-sm btn-light">Details</button>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div className="hstack gap-3 fs-15">
                                                                    <Link to="#"><i className="ri-settings-4-line"></i></Link>
                                                                    <Link to="#" className="link-success"><i className="ri-delete-bin-5-line"></i></Link>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                ...
                                                <Table className="table-sm table-nowrap mb-0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td className="fw-medium">04</td>
                                                            <td>Implement extensions</td>
                                                            <td><span className="badge bg-dark-subtle text-dark">Backlog</span></td>
                                                            <td>Maritza Blanda</td>
                                                        </tr>
                                                        <tr>
                                                ...
                                                <Table className="align-middle table-nowrap mb-0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div className="progress progress-sm">
                                                                    <div className="progress-bar bg-success-subtle text-success" role="progressbar" style={{"width": "100%"}}></div>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><Link to="#" className="link-primary">Waiting</Link></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Leslie Alexander</td>
