                            ...
                            <Row>
                                <div className="col-md">
                                    <Row className="align-items-center">
                                        ...
                                        <div className="col-md">
                                            <h4 className="fw-semibold">#VLZ135 - Create an Excellent UI for a Dashboard</h4>
                                ...
                                <div className="col-md-auto mt-md-0 mt-4">
                                    <div className="hstack gap-1 flex-wrap">
                                        ...
                                        <UncontrolledDropdown >
                                            <DropdownToggle tag="button" type="button" className="btn py-0 fs-16 text-dark">
                                        ...
                                        <button type="button" className="btn py-0 fs-16 text-dark">
