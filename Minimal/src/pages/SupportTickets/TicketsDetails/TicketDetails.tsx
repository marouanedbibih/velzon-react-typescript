                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td className="hstack text-wrap gap-1">
                                            <span className="badge bg-secondary-subtle text-secondary">Admin</span>
                                            <span className="badge bg-secondary-subtle text-secondary">UI</span>
                                            <span className="badge bg-secondary-subtle text-secondary">Dashboard</span>
                                            <span className="badge bg-secondary-subtle text-secondary">Design</span>
                                        </td>
                                    </tr>
                                </tbody>
                            </Table>
                    ...
                    <CardBody>
                        <div className="d-flex align-items-center border border-dashed p-2 rounded">
                            ...
                            <div className="flex-grow-1 ms-3">
                                <h6 className="mb-1"><Link to="#" className="link-secondary">Velzon-admin.zip</Link></h6>
                        ...
                        <div className="d-flex  align-items-center border border-dashed p-2 rounded mt-2">
                            <div className="flex-shrink-0 avatar-sm">
                                <div className="avatar-title bg-light rounded">
                                    <i className="ri-file-ppt-2-line fs-20 text-primary"></i>
                                </div>
                            </div>
                            <div className="flex-grow-1 ms-3">
                                <h6 className="mb-1"><Link to="#" className="link-secondary">Velzon-admin.ppt</Link></h6>
