                    ...
                    <div className="text-muted">
                        ...
                        <div className="pt-3 border-top border-top-dashed mt-4">
                            ...
                            <div className="hstack flex-wrap gap-2 fs-15">
                                ...
                                <div className="badge fw-medium bg-secondary-subtle text-secondary">Dashboard</div>
                                <div className="badge fw-medium bg-secondary-subtle text-secondary">Design</div>
                            </div>
                        </div>
                    </div>
                </CardBody>
