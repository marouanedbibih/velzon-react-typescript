            ...
            <Card>
                <CardBody className="text-center">
                    ...
                    <div className="hstack gap-2 justify-content-center">
                        <button className="btn btn-primary btn-sm"><i className="ri-stop-circle-line align-bottom me-1"></i> Stop</button>
                        <button className="btn btn-soft-secondary btn-sm"><i className="ri-play-circle-line align-bottom me-1"></i> Start</button>
                    </div>
                </CardBody>
            </Card>
            <Card className="mb-3">
                        ...
                        <table className="table mb-0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span className="badge bg-primary-subtle text-primary">High</span></td>
                                </tr>
                                <tr>
                                    <td className="fw-medium">Status</td>
                                    <td><span className="badge bg-success-subtle text-success">Inprogress</span></td>
                                </tr>
                                <tr>
                ...
                <div className="card-body">
                    <div className="d-flex mb-3">
                        ...
                        <div className="flex-shrink-0">
                            <button type="button" className="btn btn-soft-primary btn-sm" data-bs-toggle="modal" onClick={toggle} data-bs-target="#inviteMembersModal"><i className="ri-share-line me-1 align-bottom"></i> Assigned Member</button>
                        </div>
                    </div>
                    <ul className="list-unstyled vstack gap-3 mb-0">
                        <li>
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-grow-1 ms-2">
                                    <h6 className="mb-1"><Link to="/pages-profile" className="link-secondary">Tonya Noble</Link></h6>
                        ...
                        <li>
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-grow-1 ms-2">
                                    <h6 className="mb-1"><Link to="/pages-profile" className="link-secondary">Thomas Taylor</Link></h6>
                        ...
                        <div className="vstack gap-3">
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-grow-1">
                                    <h5 className="fs-13 mb-0"><Link to="#" className="text-dark d-block">Nancy Martino</Link></h5>
                                </div>
                                <div className="flex-shrink-0">
                            ...
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-grow-1">
                                    <h5 className="fs-13 mb-0"><Link to="#" className="text-dark d-block">Henry Baird</Link></h5>
                                </div>
                                <div className="flex-shrink-0">
                                    <button type="button" className="btn btn-light btn-sm">Add</button>
                                </div>
                            ...
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-grow-1">
                                    <h5 className="fs-13 mb-0"><Link to="#" className="text-dark d-block">Frank Hook</Link></h5>
                                </div>
                                <div className="flex-shrink-0">
                                    <button type="button" className="btn btn-light btn-sm">Add</button>
                                </div>
                            ...
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-grow-1">
                                    <h5 className="fs-13 mb-0"><Link to="#" className="text-dark d-block">Jennifer Carter</Link></h5>
                                </div>
                                <div className="flex-shrink-0">
                                    <button type="button" className="btn btn-light btn-sm">Add</button>
                                </div>
                            ...
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-grow-1">
                                    <h5 className="fs-13 mb-0"><Link to="#" className="text-dark d-block">Alexis Clarke</Link></h5>
                                </div>
                                <div className="flex-shrink-0">
                                    <button type="button" className="btn btn-light btn-sm">Add</button>
                                </div>
                            ...
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-grow-1">
                                    <h5 className="fs-13 mb-0"><Link to="#" className="text-dark d-block">Joseph Parker</Link></h5>
                                </div>
                                <div className="flex-shrink-0">
                                    <button type="button" className="btn btn-light btn-sm">Add</button>
                                </div>
