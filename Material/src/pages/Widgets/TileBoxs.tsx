...
const TileBoxs = () => {
    return (
        <React.Fragment>
                ...
                <Col xl={12}>
                    <Card className="crm-widget">
                        <CardBody className="p-0">
                            ...
                            {(tileBoxs2 || []).map((item : any, key : any) => (
            ...
            <Row>
            {(tileBoxs3 || []).map((item : any, key : any) => (<Col xl={3} md={6} key={key}>
                    <Card className={"card-animate " + item.bgColor}>
                        <CardBody>
                            <div className="d-flex justify-content-between">
                                <div>
                                    ...
                                    <h2 className={"mt-4 ff-secondary fw-semibold " + item.counterClass}>
                                        {item.subCounter.map((item : any, key : any) => (<span className="counter-value" key={key}>
                                            <CountUp
                                                start={0}
                                                prefix={item.prefix}
                                                suffix={item.suffix}
                                ...
                                <div>
                                    <div className="avatar-sm flex-shrink-0">
                                        <span className={"avatar-title shadow rounded-circle fs-2 bg-" + item.iconClass}>
                                            <FeatherIcon
                                                icon={item.feaIcon}
            ...
            <Row>
            {(tileBoxes4 || []).map((item : any, key : any) => (<Col xl={3} md={6} key={key}>
