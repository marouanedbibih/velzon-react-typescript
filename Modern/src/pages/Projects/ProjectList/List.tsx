                                        ...
                                        <div className="d-flex flex-column h-100">
                                            ...
                                            <div className="mt-auto">
                                                ...
                                                <div className="progress progress-sm animated-progess">
                                                    <div className="progress-bar bg-success" role="progressbar" style={{ width: item.progressBar }}>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <Card>
                                        <CardBody>
                                            ...
                                            <div>
                                                ...
                                                <div className="progress progress-sm animated-progess">
                                                    <div className="progress-bar bg-secondary" role="progressbar" style={{ width: item.progressBar }}>
                                                    </div>
                                                </div>
                                            </div>
                                        </CardBody>
                                                ...
                                                <div>
                                                    ...
                                                    <div className="progress progress-sm animated-progess">
                                                        <div className="progress-bar bg-primary"
                                                            role="progressbar" style={{ width: item.progressBar }}>
                                                        </div>
                                                    </div>
                                                </div>
                                            </CardBody>
