                            ...
                            <div className="form-container active">
                                <form action="" id="card-form-elem" autoComplete="off">
                                    <div className="mb-3">
                                        ...
                                        <input onFocus={(e:any) => handleInputFocus(e)} onChange={(e:any) => onChangeHandler(e, 'cardNumber')} maxLength={16} name="cardNumber" className="form-control" placeholder="Card number" type="number" id="card-number-input" />
                                    </div>
                                    <div className="mb-3">
                                        <label htmlFor="card-name-input" className="form-label">Card Holder</label>
                                        <input onFocus={(e:any) => handleInputFocus(e)} onChange={(e:any) => onChangeHandler(e, 'cardHolder')} className="form-control" name='cardHolder' placeholder="Full name" type="text" id="card-name-input" />
                                    </div>
                                    <Row>
                                        <Col sm={6}>
                                            <div className="mb-3">
                                                <label htmlFor="card-expiry-input" className="form-label">Expiry</label>
                                                {/* <input onFocus={(e:any) => handleInputFocus(e)} onChange={(e:any) => onChangeHandler(e, 'expiry')} name='expiry' className="form-control" placeholder="MM/YY" type="tel" id="card-expiry-input" /> */}
                                                <Cleave
                                                    placeholder="MM/YY"
                                                    options={{
                                                        date: true,
                                        ...
                                        <Col sm={6}>
                                            <div className="mb-3">
                                                ...
                                                <input onFocus={(e:any) => handleInputFocus(e)} onChange={(e:any) => onChangeHandler(e, 'cvc')} name='cvc' className="form-control" placeholder="CVC" maxLength={3}type="number" id="card-cvc-input" />
                                            </div>
                                        </Col>
                                    </Row>
