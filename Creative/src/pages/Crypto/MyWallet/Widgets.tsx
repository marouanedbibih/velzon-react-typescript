                ...
                <CardBody className="bg-warning-subtle">
                    <div className="d-flex">
                        <div className="flex-grow-1">
                            ...
                            <h2>$61,91,967<small className="text-muted fs-15">.29</small></h2>
                ...
                <CardBody>
                    <div className="d-flex">
                        <div className="flex-grow-1">
                            ...
                            <h2>$2,74,365<small className="text-muted fs-15">.84</small></h2>
                ...
                <CardBody>
                    <div className="d-flex">
                        <div className="flex-grow-1">
                            ...
                            <h2>$32,67,120<small className="text-muted fs-15">.42</small></h2>
