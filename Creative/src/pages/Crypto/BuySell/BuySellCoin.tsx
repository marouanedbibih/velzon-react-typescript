                                    ...
                                    <div className="mt-3 pt-2">
                                        <div className="d-flex mb-2">
                                            <div className="flex-grow-1">
                                                <p className="fs-14 mb-0">Transaction Fees<span className="text-muted ms-1 fs-12">(0.05%)</span></p>
                                            </div>
                                        ...
                                        <div className="d-flex mb-2">
                                            <div className="flex-grow-1">
                                                <p className="fs-14 mb-0">Minimum Received<span className="text-muted ms-1 fs-12">(2%)</span></p>
                                            </div>
                                            <div className="flex-shrink-0">
