                            ...
                            <Card>
                                <CardHeader className="border-0">
                                    <Row className="justify-content-center mb-4">
                                        ...
                                        <Col lg={12}>
                                            <h5 className="fs-16 fw-bold text-center mb-0">Showing results for "<span className="text-primary fw-semibold fst-italic">Admin Dashboard</span> "</h5>
                                        </Col>
                                    </Row>
                                    ...
                                    <TabContent activeTab={activeTab} className="text-muted">
                                        <TabPane tabId="1">
                                            <div className="pb-3">
                                                ...
                                                <p className="text-muted mb-2">Velzon admin is super flexible, powerful, clean, modern & responsive admin template based on <span className="fw-bold">bootstrap 5</span> stable with unlimited possibilities. You can simply change to any layout or mode by changing a couple of lines of code. You can start small and large projects or update design in your existing project using Velzon it is very quick and easy as it is beautiful, adroit, and delivers the ultimate user experience.</p>
                                                ...
                                                <Row>
                                                    <Col xl={4} lg={10}>
                                                        <Row className="g-2">
                                                            <Col md={3} sm={6}>
                                                                <div>
                                                                    <Link to={smallImage1} target="_blank" className="image-popup d-block">
                                            ...
                                            <div className="py-3">
                                                ...
                                                <p className="text-muted mb-2">Minia react is a simple and beautiful admin template built with Bootstrap ^5.1.3. It has <span className="fw-bold">5+ different layouts and 3 modes</span> ( Dark, Light & RTL ) which are managed by SCSS only. You can simply change to any layouts or mode by changing a couple of lines code.</p>
                                                <ul className="list-inline d-flex align-items-center g-3 text-muted fs-14 mb-0">
                                                                ...
                                                                <div className="d-sm-flex">
                                                                    ...
                                                                    <div className="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                                        <ul className="list-inline mb-2">
                                                                            <li className="list-inline-item"><span className={`badge bg-${item.badgeClass}-subtle text-${item.badgeClass} fs-12`}>{item.badgeText}</span></li>
                                                                        </ul>
