                                                            ...
                                                            <Col xs={6} md={4}>
                                                                <div className="d-flex mt-4">
                                                                    ...
                                                                    <div className="flex-grow-1 overflow-hidden">
                                                                        ...
                                                                        <Link to="#" className="fw-semibold fs-15">www.velzon.com</Link>
                                                                    </div>
                                                                </div>
                                                            </Col>
                                                        </Row>
                                                    ...
                                                    <div className="acitivity-item py-3 d-flex">
                                                        ...
                                                        <div className="flex-grow-1 ms-3">
                                                            <h6 className="mb-1">Your order is placed <span
                                                                className="badge bg-success-subtle text-success align-middle">Out
                                                                of Delivery</span></h6>
                                                            ...
                                                            <Card className={`profile-project-card shadow-none profile-project-${item.cardBorderColor}`}>
                                                                <CardBody className="p-4">
                                                                    <div className="d-flex">
                                                                        ...
                                                                        <div className="flex-shrink-0 ms-2">
                                                                            <div className={`badge bg-${item.badgeClass}-subtle text-${item.badgeClass} fs-12`}>
                                                                                {item.badgeText}</div>
                                                                        </div>
                                                                    </div>
                                                                            ...
                                                                            <td>
                                                                                <div className="d-flex align-items-center">
                                                                                    ...
                                                                                    <div className="ms-3 flex-grow-1">
                                                                                        <h6 className="fs-16 mb-0"><Link to="#">{item.fileName}</Link>
                                                                                        </h6>
                                                                                    </div>
                                                                                </div>
                                                                            </td>
