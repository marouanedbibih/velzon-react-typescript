                                                ...
                                                <div className="card pt-2 border-0 item-box text-center">
                                                    <div className="timeline-content p-3 rounded">
                                                        <div>
                                                            ...
                                                            <h6 className="fs-15 mb-0">Plateform Development</h6>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="card pt-2 border-0 item-box text-center">
                                                    <div className="timeline-content p-3 rounded">
                                                        <div>
                                                            ...
                                                            <h6 className="fs-15 mb-0">Release Bank & Cards Phase</h6>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="card pt-2 border-0 item-box text-center">
                                                    <div className="timeline-content p-3 rounded">
                                                        <div>
                                                            ...
                                                            <h6 className="fs-15 mb-0">Beta Launch of Plateform</h6>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="card pt-2 border-0 item-box text-center">
                                                    <div className="timeline-content p-3 rounded">
                                                        <div>
                                                            ...
                                                            <h6 className="fs-15 mb-0">First Crypto Bank Transfers</h6>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="card pt-2 border-0 item-box text-center">
                                                    <div className="timeline-content p-3 rounded">
                                                        <div>
                                                            ...
                                                            <h6 className="fs-15 mb-0">Launch Ethbay Services</h6>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="card pt-2 border-0 item-box text-center">
                                                    <div className="timeline-content p-3 rounded">
                                                        <div>
                                                            ...
                                                            <h6 className="fs-15 mb-0">Fastest Crypto Transaction</h6>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="card pt-2 border-0 item-box text-center">
                                                    <div className="timeline-content p-3 rounded">
                                                        <div>
                                                            ...
                                                            <h6 className="fs-15 mb-0">Crypto Blockchain Release</h6>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="card pt-2 border-0 item-box text-center">
                                                    <div className="timeline-content p-3 rounded">
                                                        <div>
                                                            ...
                                                            <h6 className="fs-15 mb-0">Launch Ethereum Classifieds</h6>
                                                        </div>
                                                    </div>
