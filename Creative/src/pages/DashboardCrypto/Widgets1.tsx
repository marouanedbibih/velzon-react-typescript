                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <div className="d-flex align-items-center">
                                        ...
                                        <h6 className="ms-2 mb-0 fs-15">{item.label}</h6>
                                    </div>
                                    <Row className="align-items-end g-0">
                                        <Col xs={6}>
                                            <h5 className="mb-1 mt-4">{item.price}</h5>
                                            <p className={"fw-semibold mb-0 text-" + item.changeClass}>{item.change}<span className="text-muted ms-2 fs-13 text-uppercase">({item.coinName})</span></p>
                                        </Col>
                                        <Col xs={6}>
