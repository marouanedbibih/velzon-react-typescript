                ...
                <Card className="card-height-100">
                    ...
                    <CardBody className="p-0">
                        <SimpleBar style={{ height: "390px" }}>
                            <div className="p-3">
                                <h6 className="text-muted text-uppercase mb-3 fs-12">25 Dec 2021</h6>
                                <div className="d-flex align-items-center">
                                    ...
                                    <div className="flex-grow-1 ms-3">
                                        <h6 className="fs-15 mb-1">Bought Bitcoin</h6>
                                        <p className="text-muted fs-13 mb-0">
                                            <i className="mdi mdi-circle-medium text-success fs-15 align-middle"></i> Visa Debit Card ***6
                                        </p>
                                    </div>
                                ...
                                <div className="d-flex align-items-center mt-3">
                                    ...
                                    <div className="flex-grow-1 ms-3">
                                        <h6 className="fs-15 mb-1">Sent Ethereum</h6>
                                        <p className="text-muted fs-13 mb-0">
                                            <i className="mdi mdi-circle-medium text-warning fs-15 align-middle"></i> Sofia Cunha
                                        </p>
                                    </div>
                                    <div className="flex-shrink-0 text-end">
                                ...
                                <h6 className="text-muted text-uppercase mb-3 mt-4 fs-12">24 Dec 2021</h6>
                                <div className="d-flex align-items-center">
                                    <div className="avatar-xs flex-shrink-0">
                                        <span className="avatar-title bg-light rounded-circle">
                                            <FeatherIcon
                                    ...
                                    <div className="flex-grow-1 ms-3">
                                        <h6 className="fs-15 mb-1">Sell Dash</h6>
                                        <p className="text-muted fs-13 mb-0">
                                            <i className="mdi mdi-circle-medium text-danger fs-15 align-middle"></i> www.cryptomarket.com
                                        </p>
                                    </div>
                                    <div className="flex-shrink-0 text-end">
                                ...
                                <div className="d-flex align-items-center mt-3">
                                    ...
                                    <div className="flex-grow-1 ms-3">
                                        <h6 className="fs-15 mb-1">Sell Dogecoin</h6>
                                        <p className="text-muted fs-13 mb-0">
                                            <i className="mdi mdi-circle-medium text-success fs-15 align-middle"></i> www.coinmarket.com
                                        </p>
                                    </div>
                                    <div className="flex-shrink-0 text-end">
                                ...
                                <div className="d-flex align-items-center mt-3">
                                    ...
                                    <div className="flex-grow-1 ms-3">
                                        <h6 className="fs-15 mb-1">Bought Litecoin</h6>
                                        <p className="text-muted fs-13 mb-0">
                                            <i className="mdi mdi-circle-medium text-warning fs-15 align-middle"></i> Payment via Wallet
                                        </p>
                                    </div>
                                    <div className="flex-shrink-0 text-end">
