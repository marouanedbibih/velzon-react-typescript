                ...
                <Row>
                    ...
                    <CardBody className="p-4">
                      <Row className="g-3">
                        <Col lg={3} className="col-6">
                          ...
                          <h5 className="fs-15 mb-0">#VL<span id="invoice-no">25000355</span></h5>
                        </Col>

                        <Col lg={3} className="col-6">
                          <p className="text-muted mb-2 text-uppercase fw-semibold fs-13">Date</p>
                          <h5 className="fs-15 mb-0"><span id="invoice-date">23 Nov, 2021</span> <small className="text-muted" id="invoice-time">02:36PM</small></h5>
                        </Col>

                        <Col lg={3} className="col-6">
                          <p className="text-muted mb-2 text-uppercase fw-semibold fs-13">Payment Status</p>
                          <span className="badge bg-success-subtle text-success fs-12" id="payment-status">Paid</span>
                        </Col>

                        <Col lg={3} className="col-6">
                          <p className="text-muted mb-2 text-uppercase fw-semibold fs-13">Total Amount</p>
                          <h5 className="fs-15 mb-0">$<span id="total-amount">755.96</span></h5>
                        </Col>
                  ...
                  <Col lg={12}>
                    <CardBody className="p-4 border-top border-top-dashed">
                      <Row className="g-3">
                        <Col className="col-6">
                          <h6 className="text-muted text-uppercase fw-semibold mb-3 fs-13">Billing Address</h6>
                        ...
                        <Col className="col-6">
                          <h6 className="text-muted text-uppercase fw-semibold mb-3 fs-13">Shipping Address</h6>
                  ...
                  <Col lg={12}>
                    <CardBody className="p-4">
                          ...
                          <tbody id="products-list">
                            <tr>
                              ...
                              <td className="text-start">
                                <span className="fw-semibold">Sweatshirt for Men (Pink)</span>
                            ...
                            <tr>
                              <th scope="row">02</th>
                              <td className="text-start">
                                <span className="fw-semibold">Noise NoiseFit Endure Smart Watch</span>
                            ...
                            <tr>
                              <th scope="row">03</th>
                              <td className="text-start">
                                <span className="fw-semibold">350 ml Glass Grocery Container</span>
                            ...
                            <tr>
                              <th scope="row">04</th>
                              <td className="text-start">
                                <span className="fw-semibold">Fabric Dual Tone Living Room Chair</span>
                      ...
                      <div className="mt-3">
                        <h6 className="text-muted text-uppercase fw-semibold mb-3 fs-13">Payment Details:</h6>
