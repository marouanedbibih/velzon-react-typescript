              ...
              <CardBody>
                ...
                <div className="d-flex align-items-end justify-content-between mt-4">
                  <div>
                    <h4
                      className={
                        "fs-22 fw-bold ff-secondary mb-4 " + item.counterClass
                      }
                    >
                  ...
                  <div className="avatar-sm flex-shrink-0">
                    <span
                      className={"avatar-title rounded fs-3 bg-"+item.iconClass + " " +item.iconClass + " " + item.opacity}
                    >
              ...
              <CardBody>
                <div className="d-flex align-items-center">
                  ...
                  <div className="flex-grow-1 ms-3">
                    <p
                      className={
                        "text-uppercase fw-semibold mb-3 text-" +
                        item.labelClass
                      }
                    >
                      {item.label}
                  ...
                  <div className="flex-shrink-0 align-self-center">
                    <span
                      className={
                        "fs-12 badge bg-" + item.percentageClass + " text-" +
                        item.percentageClass  + " " + item.opacity
                      }
                    >
                      <i
