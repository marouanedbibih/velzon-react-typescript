                                    ...
                                    <ListGroupItem className="ps-0" key={key}>
                                        <Row className="align-items-center g-3">
                                            ...
                                            <Col className="col">
                                                ...
                                                <Link to="#" className="text-reset fs-15 mb-0">{item.caption}</Link>
                                            </Col>
                            ...
                            <Card className="card-height-100">
                                ...
                                <CardBody className="p-0">
                                    ...
                                    <div className="align-items-center p-3 justify-content-between d-flex">
                                        <div className="flex-shrink-0">
                                            <div className="text-muted"><span className="fw-bold">4</span> of <span className="fw-bold">10</span> remaining</div>
                                        </div>
