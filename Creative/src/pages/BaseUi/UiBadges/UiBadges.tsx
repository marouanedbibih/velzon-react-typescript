                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <div className="d-flex flex-wrap gap-2">
                                            ...
                                            <span className="badge rounded-pill bg-light-subtle text-body text-dark">Light</span>
                                        </div>
                                    </div>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <p className="text-muted">
                                        Use the <code>badge-border</code> and <code>bg-*-subtle text-*</code> with below mentioned modifier classes to make badges with border & soft background.
                                    </p>
                                    <div className="live-preview">
                                        ...
                                        <div className="d-flex flex-wrap gap-2">
                                            ...
                                            <span className="badge bg-light-subtle text-body badge-border text-dark">Light</span>
                                        </div>
                                    </div>
