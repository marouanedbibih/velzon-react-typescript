                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={6}>
                                                ...
                                                <h6>Danger Alert</h6>
                                                <UncontrolledAlert color="danger" className="aalert alert-danger alert-dismissible bg-danger text-white alert-label-icon fade show mb-xl-0" closeClassName="btn-close-white">
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={6}>
                                                ...
                                                <Alert color="primary" className="alert bg-primary border-primary text-white">
                                                    <strong>Hi!</strong> - Solid <b>primary alert</b> example
                                                </Alert>

                                                <h6>Secondary Solid Alert</h6>
                                                <Alert color="secondary" className="alert bg-secondary border-secondary text-white">
                                                    <strong>How are you!</strong> - Solid <b>secondary alert</b> example
                                                </Alert>

                                                <h6>Success Solid Alert</h6>
                                                <Alert color="success" className="alert bg-success border-success text-white">
                                                    <strong>Yey! Everything worked! </strong> - Solid <b>success alert</b> example
                                                </Alert>

                                                <h6>Danger Solid Alert</h6>
                                                <Alert color="danger" className="alert bg-danger border-danger text-white mb-xl-0">
                                            ...
                                            <Col xl={6}>
                                                ...
                                                <Alert color="warning" className="alert bg-warning border-warning text-white">
                                                ...
                                                <Alert color="dark" className="alert bg-dark border-dark text-white mb-0">
