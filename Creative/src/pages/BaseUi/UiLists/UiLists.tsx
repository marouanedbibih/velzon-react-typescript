                                        ...
                                        <ListGroup>
                                            <ListGroupItem tag="a" to="#" className="list-group-item-action active">
                                                ...
                                                <div className="d-flex mb-2 align-items-center">
                                                    ...
                                                    <div className="flex-grow-1 ms-3">
                                                        <h5 className="list-title fs-16 mb-1">Charlie Pritchard</h5>
                                            ...
                                            <ListGroupItem tag="a" to="#" className="list-group-item-action">
                                                ...
                                                <div className="d-flex mb-2 align-items-center">
                                                    ...
                                                    <div className="flex-grow-1 ms-3">
                                                        <h5 className="list-title fs-16 mb-1">Dominic Charlton</h5>
                                                        <p className="list-text mb-0 fs-13">12 min Ago</p>
                                                    </div>
                                                </div>
                                            ...
                                            <ListGroupItem tag="a" to="#" className="list-group-item-action">
                                                ...
                                                <div className="d-flex mb-2 align-items-center">
                                                    ...
                                                    <div className="flex-grow-1 ms-3">
                                                        <h5 className="list-title fs-16 mb-1">Declan Long</h5>
                                                        <p className="list-text mb-0 fs-13">12 min Ago</p>
                                                    </div>
                                                </div>
                                            ...
                                            <ListGroupItem tag="a" to="#" className="list-group-item-action">
                                                ...
                                                <div className="d-flex mb-2 align-items-center">
                                                    ...
                                                    <div className="flex-grow-1 ms-3">
                                                        <h5 className="list-title fs-16 mb-1">Angela Bernier</h5>
                                    ...
                                    <div className="live-preview">
                                        <ListGroup>
                                            <ListGroupItem tag="label">
                                                <Input className="form-check-input me-1" type="checkbox" value="" /> Declined Payment
                                            </ListGroupItem>
                                            <ListGroupItem tag="label">
                                                <Input className="form-check-input me-1" type="checkbox" value="" defaultChecked /> Delivery Error
                                            </ListGroupItem>
                                            <ListGroupItem tag="label">
                                                <Input className="form-check-input me-1" type="checkbox" value="" defaultChecked /> Wrong Amount
                                            </ListGroupItem>
                                            <ListGroupItem tag="label">
                                                <Input className="form-check-input me-1" type="checkbox" value="" /> Wrong Address
                                            </ListGroupItem>
                                            <ListGroupItem tag="label">
                                                <Input className="form-check-input me-1" type="checkbox" value="" /> Wrong UX/UI Solution
                                            </ListGroupItem>
                                        </ListGroup>
                                    </div>
