                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>btn-soft-</code>  class with the below-mentioned variation to create a button with the soft background.</p>                                        <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-2">
                                            ...
                                            <Button className="btn-soft-secondary waves-effect waves-light"> Secondary </Button>
                                            <Button className="btn-soft-success waves-effect waves-light"> Success </Button>
                                            <Button className="btn-soft-info waves-effect waves-light"> Info </Button>
                                            <Button className="btn-soft-warning waves-effect waves-light"> Warning </Button>
                                            <Button className="btn-soft-danger waves-effect waves-light"> Danger </Button>
                                            <Button className="btn-soft-dark waves-effect waves-light"> Dark </Button>
                                        </div>
                                    </div>
                                    <div className="d-none code-view">
                                        <pre className="language-markup" style={{ height: "275px" }}>
                        ...
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-2">
                                            <Button color="primary" className="btn btn-ghost-primary waves-effect waves-light">Primary</Button>
                                            <Button color="secondary" className="btn btn-ghost-secondary waves-effect waves-light">Secondary</Button>
                                            <Button color="success" className="btn btn-ghost-success waves-effect waves-light">Success</Button>
                                            <Button color="info" className="btn btn-ghost-info waves-effect waves-light">Info</Button>
                                            <Button color="warning" className="btn btn-ghost-warning waves-effect waves-light">Warning</Button>
                                            <Button color="danger" className="btn btn-ghost-danger waves-effect waves-light">Danger</Button>
                                            <Button color="dark" className="btn btn-ghost-dark waves-effect waves-light">Dark</Button>
                                        </div>
                                    </div>
