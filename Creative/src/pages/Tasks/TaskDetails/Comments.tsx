                        ...
                        <TabPane tabId="1">
                            ...
                            <SimpleBar style={{ height: "508px" }} className="px-3 mx-n3 mb-2">
                                ...
                                <div className="d-flex">
                                    ...
                                    <div className="flex-grow-1 ms-3">
                                        <h5 className="fs-15"><Link to="/pages-profile">Tonya Noble</Link> <small className="text-muted">26 min ago</small></h5>
                                        ...
                                        <div className="d-flex mt-4">
                                            ...
                                            <div className="flex-grow-1 ms-3">
                                                <h5 className="fs-15"><Link to="/pages-profile">Nancy Martino</Link> <small className="text-muted">8 sec ago</small></h5>
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="ms-3 flex-grow-1">
                                                        <h6 className="fs-15 mb-0"><Link to="#" className="link-secondary">App pages.zip</Link></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>Zip File</td>
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="ms-3 flex-grow-1">
                                                        <h6 className="fs-15 mb-0"><Link to="#" className="link-secondary">Velzon admin.ppt</Link></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>PPT File</td>
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="ms-3 flex-grow-1">
                                                        <h6 className="fs-15 mb-0"><Link to="#" className="link-secondary">Images.zip</Link></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>ZIP File</td>
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="ms-3 flex-grow-1">
                                                        <h6 className="fs-15 mb-0"><Link to="#" className="link-secondary">Bg-pattern.png</Link></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>PNG File</td>
                                            ...
                                            <th scope="row">
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="flex-grow-1 ms-2">
                                                        <Link to="/pages-profile" className="fw-medium link-secondary">Thomas Taylor</Link>
                                                    </div>
                                                </div>
                                            </th>
                                            <td>02 Jan, 2022</td>
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="flex-grow-1 ms-2">
                                                        <Link to="/pages-profile" className="fw-medium link-secondary">Tonya Noble</Link>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>28 Dec, 2021</td>
