              ...
              <div className="mt-2 vstack gap-3">
                <Link to="#" className="d-flex align-items-center">
                  ...
                  <div className="flex-grow-1 chat-user-box overflow-hidden">
                    <h5 className="fs-14 text-truncate mb-0">Scott Median</h5>
                ...
                <Link to="#" className="d-flex align-items-center">
                  ...
                  <div className="flex-grow-1 chat-user-box overflow-hidden">
                    <h5 className="fs-14 text-truncate mb-0">Julian Rosa</h5>
                    <small className="text-muted text-truncate mb-0">
                      What about our next..
                    </small>
                  </div>
                ...
                <Link to="#" className="d-flex align-items-center">
                  ...
                  <div className="flex-grow-1 chat-user-box overflow-hidden">
                    <h5 className="fs-14 text-truncate mb-0">David Medina</h5>
                    <small className="text-muted text-truncate mb-0">
                ...
                <Link to="#" className="d-flex align-items-center">
                  ...
                  <div className="flex-grow-1 chat-user-box overflow-hidden">
                    <h5 className="fs-14 text-truncate mb-0">Jay Baker</h5>
                    <small className="text-muted text-truncate mb-0">
                      Wow that's great
                    </small>
                  </div>
