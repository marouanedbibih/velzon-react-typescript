                    ...
                    <div className="d-flex">
                      ...
                      <div className="ms-3 flex-grow-1">
                        ...
                        <div className="hstack gap-2">
                          <span
                            className={`badge bg-${item.s1[1]}-subtle text-${item.s1[1]}`}
                          >
                            {item.s1[0]}
                          </span>
                          <span
                            className={`badge bg-${item.s2[1]}-subtle text-${item.s2[1]}`}
                          >
                            {item.s2[0]}
                          </span>
                          {item.s3 ? (
                            <span
                              className={`badge bg-${item.s3[1]}-subtle text-${item.s3[1]}`}
                            >
                              {item.s3[0]}
                            </span>
                          ) : (
          ...
          <Row className="align-items-center gy-4">
            <Col lg={6} className="order-2 order-lg-1">
              <div className="text-muted mt-5 mt-lg-0">
                <h5 className="fs-12 text-uppercase text-danger fw-semibold">
            ...
            <Col lg={4} sm={7} className="col-10 ms-lg-auto mx-auto order-1 order-lg-2">
              <div>
                <Card className="shadow-lg">
                  <CardBody>
                    <button
                ...
                <Card className="shadow-lg bg-secondary mb-0 features-company-widgets rounded-3">
                  <CardBody>
