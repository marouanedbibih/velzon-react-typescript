                    ...
                    <Row className="justify-content-center">
                        <Col lg={8}>
                            <div className="text-center mb-5">
                                <h1 className="mb-3 ff-secondary fw-bold lh-base">A Digital web design studio creating modern & engaging online</h1>
                        ...
                        <Col lg={4}>
                            <div className="d-flex p-3">
                                ...
                                <div className="flex-grow-1">
                                    ...
                                    <div>
                                        <Link to="#" className="fs-13 fw-semibold">Learn More <i className="ri-arrow-right-s-line align-bottom"></i></Link>
                                    </div>
                                </div>
                            </div>
                        </Col>
