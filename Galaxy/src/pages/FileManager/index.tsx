...
const FileManager = () => {
    ...
    return (
        <React.Fragment>
                                                    ...
                                                    <tr key={key}>
                                                        ...
                                                        <td>
                                                            <div className="d-flex gap-3 justify-content-center">
                                                                <button type="button" className="btn btn-ghost-primary btn-icon btn-sm favourite-btn" onClick={(e) => FavoriteeBtn(e.target)}>
                        ...
                        <div className="file-manager-detail-content p-3 py-0 border">
                            <div className="mx-n3 pt-3 px-3 file-detail-content-scroll">
                                <div id="folder-overview">
                                    ...
                                    <SimpleDonutCharts dataColors='["--vz-primary", "--vz-primary-rgb, 0.75", "--vz-primary-rgb, 0.60", "--vz-primary-rgb, 0.40"]' className="apex-charts mt-3" dir="ltr" />
                                    <div className="mt-4">
            ...
            {/* Folder Modal */}
            <Modal Modal className="fade zoomIn" isOpen={modalFolder} toggle={() => setModalFolder(!modalFolder)} id="createFolderModal" modalClassName="zoomIn" centered tabIndex={-1} >
                <ModalHeader className="p-3 bg-primary-subtle" id="createFolderModalLabel" toggle={() => setModalFolder(!modalFolder)}> {isEdit ? "Folder Rename" : "Create Folder"} </ModalHeader>
                <ModalBody>
                    ...
                    >
                        ...
                        <div className="hstack gap-2 justify-content-end">
                            <button type="button" className="btn btn-ghost-danger" onClick={() => setModalFolder(false)}><i className="ri-close-line align-bottom"></i> Close</button>
            ...
            {/* File Modal */}
            <Modal Modal id="createFileModal" isOpen={modalFile} toggle={fileToggle} modalClassName="zoomIn" centered tabIndex={-1} >
                <ModalHeader toggle={fileToggle} className="p-3 bg-primary-subtle">{!!isEdit ? "File Rename" : "Create File"}</ModalHeader>
                <ModalBody>
                    ...
                    >
                        ...
                        <div className="hstack gap-2 justify-content-end">
                            <button type="button" className="btn btn-ghost-danger" onClick={() => setModalFile(false)}><i className="ri-close-line align-bottom"></i> Close</button>
