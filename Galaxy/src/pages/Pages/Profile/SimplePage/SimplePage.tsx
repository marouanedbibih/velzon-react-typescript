            ...
            <div className="page-content">
                <Container fluid>
                    <div className="profile-foreground position-relative mx-n4 mt-n4">
                        <div className="profile-wid-bg bg-transparent border-top">
                    ...
                    <div className="pt-4 mb-4 mb-lg-3 pb-lg-4">
                        <Row className="g-4">
                            ...
                            <Col>
                                <div className="p-2">
                                    <h3 className="mb-1">Anna Adame</h3>
                                    <p className="text-muted">Owner & Founder</p>
                                    <div className="hstack text-muted gap-1">
                                        <div className="me-2"><i
                                            className="ri-map-pin-user-line me-1 fs-16 align-bottom text-body"></i>California,
                                            United States</div>
                                        <div><i
                                            className="ri-building-line me-1 fs-16 align-bottom text-body"></i>Themesbrand
                                        </div>
                                    </div>
                                </div>
                            </Col>
                                ...
                                <Row className="text text-center">
                                    <Col lg={6} xs={4}>
                                        <div className="p-2">
                                            ...
                                            <p className="fs-14 text-muted mb-0">Followers</p>
                                        </div>
                                    </Col>
                                    <Col lg={6} xs={4}>
                                        <div className="p-2">
                                            <h4 className="mb-1">1.3K</h4>
                                            <p className="fs-14 text-muted mb-0">Following</p>
                                        </div>
                                    </Col>
                                </Row>
                            </Col>
