                ...
                <div className="card-body">
                    <div className="d-flex mb-3">
                        ...
                        <div className="flex-shrink-0">
                            <button type="button" className="btn btn-soft-primary btn-sm" onClick={toggle}  data-bs-target="#inviteMembersModal"><i className="ri-share-line me-1 align-bottom"></i> Assigned Member</button>
                        </div>
                    </div>
                                ...
                                <div className="flex-shrink-0">
                                    <UncontrolledDropdown>
                                        ...
                                        <DropdownMenu>
                                            ...
                                            <div><DropdownItem><i className="ri-star-fill text-muted me-2 align-bottom"></i>Favoritee</DropdownItem></div>
