...
const EmailToolbar = () => {
    ...
    return (
        <React.Fragment>
                ...
                <div className="p-4 d-flex flex-column h-100">
                    ...
                    >
                        ...
                        <div className="border-top border-top-dashed pt-3 mt-3">
                            <Link to="#" className="btn btn-icon btn-sm btn-soft-info rounded-pill float-end" >
                            ...
                            <div className="mt-2 vstack email-chat-list mx-n4">
                                ...
                                {chatData.map((item: any, key: any) => (<Link to="#" className="d-flex align-items-center" key={key}>
            ...
            <div className="email-content bg-transparent border">
                                    ...
                                    <li className={classnames({ unread: item.unread })} key={key} id={item.forId}>
                                        <div className="col-mail col-mail-1">
                                            <div className="form-check checkbox-wrapper-mail fs-14">
                                                <input onChange={(e: any) => onChangeCheckBox(e.target.value, e.target.checked)} className="form-check-input" type="checkbox" value={item.forId} id={item.forId} />
                ...
                <div className="p-4 d-flex flex-column h-100">
                    <div className="pb-4 border-bottom border-bottom-dashed">
                        <Row>
                            <Col className="col">
                                <div className="">
                                    <button type="button" className="btn btn-soft-danger btn-icon btn-sm fs-16 close-btn-email" id="close-btn-email" onClick={() => sidebarToggle("")}>
                            ...
                            <Col className="col-auto">
                                <div className="hstack gap-sm-1 align-items-center flex-wrap email-topbar-link">
                                    <button type="button" className={emailinfo.category === "starred" ? "btn btn-ghost-warning btn-icon btn-sm fs-16 favourite-btn active" : "btn btn-ghost-warning btn-icon btn-sm fs-16 favourite-btn"} onClick={() => favouriteBtn(emailinfo)}>
                                        <i className='ri-star-fill' />
                                    </button>
