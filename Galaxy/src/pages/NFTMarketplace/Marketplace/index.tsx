                            ...
                            <Card className="bg-primary" style={{ backgroundImage: `url(${BgPattern})` }}>
                                <CardBody className="p-4">
                                    ...
                                    <div className="hstack gap-2">
                                        <Link to="/apps-nft-create" className="btn btn-secondary">Create NFT</Link>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card className="overflow-hidden shadow-none border-0">
                                <CardBody className="bg-primary-subtle text-primary fw-semibold d-flex">
                                        ...
                                        <div className="d-flex align-items-center mb-3">
                                            ...
                                            <div className="bookmark-icon">
                                                <button type="button"
                                                    ...
                                                    aria-pressed="true"
                                                    onClick={(e) => FavoriteeBtn(e.target)}
                                                >
                            ...
                            <Col key={key}>
                                <Card>
                                    ...
                                    <CardBody className="text-center">
                                        ...
                                        <h5 className="mt-3 mb-1"><Link to="/pages-profile">{item.author}</Link></h5>
