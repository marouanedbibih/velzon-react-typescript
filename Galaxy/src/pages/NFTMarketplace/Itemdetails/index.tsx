                            ...
                            <Row className="g-4">
                                ...
                                <Col lg={8}>
                                    <div>
                                        ...
                                        <span className="badge bg-primary-subtle text-primary mb-3 fs-12"><i className="ri-eye-line me-1 align-bottom"></i> 8,634 people views this</span>
                                            ...
                                            <Col lg={3} sm={6}>
                                                <div className="p-2 border border-dashed rounded text-center">
                                                    <div>
                                                        ...
                                                        <h5 className="fs-17 text-primary mb-0"><i className="mdi mdi-ethereum me-1"></i> 83.06 ETH</h5>
                                                    </div>
                                                </div>
                                            </Col>
                                                        ...
                                                        <div className="mt-3">
                                                                ...
                                                                <Col>
                                                                    <div className="p-2">
                                                                        <div className="progress animated-progress progress-sm">
                                                                            <div className="progress-bar bg-priamry" role="progressbar" style={{ width: "50.16%" }}></div>
                                                                        </div>
                                                                    </div>
                                                                </Col>
                                                                <Col className="col-auto">
                                                            ...
                                                            <Row className="align-items-center g-2">
                                                                ...
                                                                <Col>
                                                                    <div className="p-2">
                                                                        <div className="progress animated-progress progress-sm">
                                                                            <div className="progress-bar bg-secondary" role="progressbar" style={{ width: "19.32%" }}></div>
                                                                        </div>
                                                                    </div>
                                                                </Col>
                                                                <Col className="col-auto">
