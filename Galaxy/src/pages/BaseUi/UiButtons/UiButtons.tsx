...
import { DefaultButtonsExample, OutlineButtonsExample, RoundedButtonsExample, SoftButtonsExample, GradientButtonsExample, AnimationButtonsExample, LabelButtonsExample, SizeButtonsExample, WidthButtonsExample, TagButtonsExample, GridButtonsExample, CheckButtonsExample, GroupButtonsExample, IconButtonsExample, ToolbarButtonsExample, GroupsizingButtonsExample, VerticalButtonsExample, GhostButtonsExample, LoadingbuttonsExample, BorderButtonsExample, CustomToggleButtonsExample, BaseClassExample, CustomSizingExample, FocusRingButtonsExample, FocusRingExample } from './UiButtonCode';
                        ...
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-2">
                                            <Button color="primary" className="btn-animation waves-effect waves-light btn btn-primary" data-text="Primary"> <span>Primary</span> </Button>
                                            <Button color="secondary" className="btn-animation waves-effect waves-light btn btn-Secondary" data-text="Secondary"> <span>Secondary</span> </Button>
                                            <Button color="success" className="btn-animation waves-effect waves-light btn btn-Success" data-text="Success"> <span>Success</span> </Button>
                                            <Button color="info" className="btn-animation waves-effect waves-light btn btn-Info" data-text="Info"> <span>Info</span> </Button>
                                            <Button color="warning" className="btn-animation waves-effect waves-light btn btn-Warning" data-text="Warning"> <span>Warning</span> </Button>
                                            <Button color="danger" className="btn-animation waves-effect waves-light btn btn-Danger" data-text="Danger"> <span>Danger</span> </Button>
                                            <Button color="dark" className="btn-animation waves-effect waves-light btn btn-Dark" data-text="Dark"> <span>Dark</span> </Button>
                                        </div>
                                    </div>
                                    <div className="d-none code-view">
                                        <pre className="language-markup" style={{ height: "275px" }}>
                                        ...
                                        <Row>
                                            <Col lg={6}>
                                                <div className="d-flex flex-wrap align-items-center gap-2">
                                                    <Button color='primary' className="custom-toggle active" onClick={(e) => FavoriteeBtn(e.target)}>
                                                        <span className="icon-on"><i className="ri-alarm-line align-bottom"></i> Active</span>
                                                        <span className="icon-off">Unactive</span>
                                                    </Button>
                                                    <Button color='secondary' className="custom-toggle active" onClick={(e) => FavoriteeBtn(e.target)}>
                                                    ...
                                                    <Button color='success' className="custom-toggle" onClick={(e) => FavoriteeBtn(e.target)}>
                                                    ...
                                                    <Button color='warning' className="custom-toggle active" onClick={(e) => FavoriteeBtn(e.target)}>
                                                    ...
                                                    <Button color='danger' className="custom-toggle" onClick={(e) => FavoriteeBtn(e.target)}>
                                                        <span className="icon-on">On</span>
                                                        <span className="icon-off">Off</span>
                                                    </Button>
                                                    <Button color='dark' className="custom-toggle" onClick={(e) => FavoriteeBtn(e.target)}>
                                            ...
                                            <Col lg={6}>
                                                <div className="d-flex flex-wrap align-items-center gap-2">
                                                    <Button color="primary" outline className="custom-toggle" onClick={(e) => FavoriteeBtn(e.target)}>
                                                        <span className="icon-on">Active</span>
                                                        <span className="icon-off">Unactive</span>
                                                    </Button>
                                                    <Button color="secondary" outline className="custom-toggle" onClick={(e) => FavoriteeBtn(e.target)}>
                                                        <span className="icon-on"><i className="ri-add-line align-bottom me-1"></i> Follow</span>
                                                        <span className="icon-off"><i className="ri-user-unfollow-line align-bottom me-1"></i> Unfollow</span>
                                                    </Button>
                                                    <Button color="success" outline className="custom-toggle active" onClick={(e) => FavoriteeBtn(e.target)}>
                                                        <span className="icon-on">On</span>
                                                        <span className="icon-off">Off</span>
                                                    </Button>
                                                    <Button color="warning" outline className="custom-toggle active" onClick={(e) => FavoriteeBtn(e.target)}>
                                                        <span className="icon-on">Follow</span>
                                                        <span className="icon-off">Unfollow</span>
                                                    </Button>
                                                    <Button color="danger" outline className="custom-toggle" onClick={(e) => FavoriteeBtn(e.target)}>
                                                        <span className="icon-on">On</span>
                                                        <span className="icon-off">Off</span>
                                                    </Button>
                                                    <Button color="dark" outline className="custom-toggle active" onClick={(e) => FavoriteeBtn(e.target)}>
                        ...
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <Button type="button" color='primary' style={{ paddingTop: '.25rem', paddingBottom: '.25rem', paddingLeft: '.5rem', paddingRight: '.5rem', fontSize: '.75rem' }}>
                                            Custom button
                                        </Button>
                                    </div>
                                    <div className="d-none code-view">
