                                ...
                                <Col xl={4} md={6}>
                                    <Card className="text-center border">
                                        <CardBody className="p-4 pb-0">
                                            ...
                                            <div>
                                                <Button color="primary"  data-bs-target="#success-Payment" onClick={() => tog_successMessage()} >Click me</Button>
                                            </div>
                                ...
                                <Col xl={4} md={6}>
                                    <Card className="text-center border">
                                        <CardBody className="p-4 pb-0">
                                            ...
                                            <div>
                                                <Button color='primary' onClick={() => tog_loginModals()}  data-bs-target="#loginModals">Click me</Button>
                                            </div>
                                ...
                                <Col xl={4} md={6}>
                                    <Card className="text-center border">
                                        <CardBody className="p-4 pb-0">
                                            ...
                                            <div>
                                                <Button color='primary' onClick={() => tog_subscribeModals()} className="btn btn-primary"  data-bs-target="#subscribeModals">Click me</Button>
                                            </div>
                                ...
                                <Col xl={4} md={6}>
                                    <Card className="text-center border">
                                        <CardBody className="p-4 pb-0">
                                            ...
                                            <div>
                                                <Button color='primary' onClick={() => tog_signUpModals()}  data-bs-target="#signupModals">Click me</Button>
                                            </div>
