                ...
                <CardBody>
                    ...
                    <div className="acitivity-timeline py-3">
                        ...
                        <div className="acitivity-item py-3 d-flex">
                            ...
                            <div className="flex-grow-1 ms-3">
                                <h6 className="mb-1">Nancy Martino <span className="badge bg-secondary-subtle text-primary align-middle">In Progress</span></h6>
                        ...
                        <div className="acitivity-item d-flex">
                            ...
                            <div className="flex-grow-1 ms-3">
                                ...
                                <p className="text-muted mb-2">User <span className="text-primary">Erica245</span> submitted a ticket.</p>
