                    ...
                    <Card>
                        <CardBody>
                            <div className="text-muted">
                                ...
                                <div>
                                    <button type="button" className="btn btn-link link-primary p-0">Read more</button>
                                </div>
                            ...
                            <form className="mt-4">
                                <Row className="g-3">
                                    ...
                                    <Col xs={12} className="text-end">
                                        <button type="button" className="btn btn-ghost-primary btn-icon waves-effect me-1"><i className="ri-attachment-line fs-16"></i></button> <Link to="#" className="btn btn-primary">Post Comments</Link>
                                    </Col>
                                </Row>
                            </form>
                        </CardBody>
                ...
                <Col xl={3} lg={4}>
                    <Card>
                        <CardBody>
                            ...
                            <div className="d-flex flex-wrap gap-2 fs-16">
                                <div className="badge fw-medium bg-primary-subtle text-primary">UI/UX</div>
                                <div className="badge fw-medium bg-primary-subtle text-primary">Figma</div>
                                <div className="badge fw-medium bg-primary-subtle text-primary">HTML</div>
                                <div className="badge fw-medium bg-primary-subtle text-primary">CSS</div>
                                <div className="badge fw-medium bg-primary-subtle text-primary">Javascript</div>
                                <div className="badge fw-medium bg-primary-subtle text-primary">C#</div>
                                <div className="badge fw-medium bg-primary-subtle text-primary">Nodejs</div>
                            </div>
                        </CardBody>
                    ...
                    <Card>
                        <CardHeader className="align-items-center d-flex border-bottom-dashed">
                            ...
                            <div className="flex-shrink-0">
                                <button type="button" className="btn btn-soft-danger btn-sm" data-bs-target="#inviteMembersModal"><i className="ri-share-line me-1 align-bottom"></i> Invite Member</button>
                            </div>
                        </CardHeader>
                                            ...
                                            <div className="d-flex align-items-center gap-1">
                                                ...
                                                <UncontrolledDropdown>
                                                    ...
                                                    <DropdownMenu>
                                                        ...
                                                        <li><DropdownItem><i className="ri-star-fill text-muted me-2 align-bottom"></i>Favoritee</DropdownItem></li>
                    ...
                    <Card>
                        <CardHeader className="align-items-center d-flex border-bottom-dashed">
                            ...
                            <div className="flex-shrink-0">
                                <button type="button" className="btn btn-soft-secondary btn-sm"><i className="ri-upload-2-fill me-1 align-bottom"></i> Upload</button>
                            </div>
                        </CardHeader>
