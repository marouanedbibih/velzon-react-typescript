                                                    ...
                                                    <div className="d-flex gap-1 align-items-center">
                                                        ...
                                                        <UncontrolledDropdown direction='start'>
                                                            ...
                                                            <DropdownMenu className="dropdown-menu-end">
                                                                ...
                                                                <DropdownItem href="#" onClick={() => onClickData(item)} data-bs-target="#removeProjectModal"><i className="ri-delete-bin-fill align-bottom me-2 text-muted"></i> Remove</DropdownItem>
                                                            </DropdownMenu>
