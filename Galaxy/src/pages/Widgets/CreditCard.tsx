                                    ...
                                    <Row>
                                        <Col sm={6}>
                                            <div className="mb-3">
                                                ...
                                                {/* <input onFocus={(e) => handleInputFocus(e)} onChange={(e) => onChangeHandler(e, 'expiry')} name='expiry' className="form-control" placeholder="MM/YY" type="tel" id="card-expiry-input" /> */}
                                                <Cleave
                                                    placeholder="MM/YY"
                                                    options={{
                                                        date: true,
                                        ...
                                        <Col sm={6}>
                                            <div className="mb-3">
                                                ...
                                                <input onFocus={(e) => handleInputFocus(e)} onChange={(e) => onChangeHandler(e, 'cvc')} name='cvc' className="form-control" placeholder="CVC" maxLength={3} type="tel" id="card-cvc-input" />
                                            </div>
                                        </Col>
                                    </Row>
