                ...
                <CardBody>
                  <Form className="form-steps" autoComplete="off">
                    <div className="text-center pt-3 pb-4 mb-1 d-flex justify-content-center">
                      <img src={logoLight} alt="logo light" height="17" className="card-logo card-logo-light" />
                      <img src={logoDark} alt="logo dark" height="17" className="card-logo card-logo-dark" />
                    </div>
