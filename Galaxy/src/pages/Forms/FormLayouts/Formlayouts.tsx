                                ...
                                <div className="card-body">
                                    ...
                                    <div className="live-preview">
                                        <form action="#" className="row g-3">
                                            ...
                                            <Col xs={12}>
                                                <div className="text-end">
                                                    <button type="submit" className="btn btn-primary" onClick={e => e.preventDefault()}>Sign in</button>
                                                </div>
                                            </Col>
                                        </form>
                                    </div>
                    ...
                    <Row >
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <Form action="#">
                                            ...
                                            <div className="text-end">
                                                <button type="submit" className="btn btn-primary" onClick={e => e.preventDefault()}>Add Leave</button>
                                            </div>
                                        </Form>
                                    </div>
                                    <div className="d-none code-view">
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Create horizontal forms with the grid by adding the <code>row</code> class to form groups and using the <code>col-*-*</code>
                                        class to specify the width of your labels and controls. Be sure to add <code>col-form-label</code>
                                        class to your <code>&lt;label&gt;</code>s as well so they’re vertically centered with their associated form controls.</p>
                                    <div className="live-preview">
                                        <form action="#">
                                            <Row className="mb-3">
                                                <Col lg={3} >
