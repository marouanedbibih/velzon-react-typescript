                            ...
                            <TabPane tabId="1">
                                <div className="p-3 bg-primary-subtle">
                                    <div className="float-end ms-2">
                                        <h6 className="text-primary mb-0">USD Balance : <span className="text-body">$12,426.07</span></h6>
                                    </div>
                                ...
                                <div className="p-3">
                                    ...
                                    <div className="mt-3 pt-2">
                                        <button type="button" className="btn btn-soft-success w-100">Buy Coin</button>
                                    </div>
                                </div>
                            </TabPane>
